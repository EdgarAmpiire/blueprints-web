...
export const Glance = () => {
  ...
  <div>
    <div className="mt-14 flex items-center flex-col">
        ...
        <div className="flex justify-between items-center w-8/12  gap-10 mt-10">
          <div className="flex items-center justify-center flex-col w-4/12">
            ...
            <div className="mt-2 flex flex-col items-center justify-center ">
              ...
              <p className="text-xs text-center mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
            </div>
          </div>
