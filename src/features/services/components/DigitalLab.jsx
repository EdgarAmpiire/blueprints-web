        ...
        <div className="bg-[#F5E5FF] rounded-xl py-10 px-10 mt-16 w-11/12 lg:w-10/12">
          <div className="grid grid-cols-2 w-full">
            <div className="flex flex-col items-start ">
              ...
              <div className="mt-5 w-8/12">
                <p className="text-[#6B6A6A] text-sm">
                  A digital marketing strategy is a set of planned, strategic
                  and tactical actions to acquire and retain the attention of
        ...
        <div className="bg-[#F3F3F3] rounded-xl py-10 px-10 mt-10 w-11/12 lg:w-10/12">
          <div className="grid grid-cols-2 w-full">
            ...
            <div className="flex flex-col items-start ">
              ...
              <div className="mt-5 w-8/12">
                <p className="text-[#6B6A6A] text-sm">
                  Product development is the end-to-end process of driving an
                  idea from concept to commercialization and beyond in its
                  lifecycle.
                </p>
                <p className="mt-5 text-[#6B6A6A] text-sm ">Services:</p>
                <ul class="list-disc mt-5 text-[#6B6A6A] text-sm ml-8">
        ...
        <div className="bg-[#ECEBFF] rounded-xl py-10 px-10 mt-16 w-11/12 lg:w-10/12">
          <div className="grid grid-cols-2 w-full">
            <div className="flex flex-col items-start ">
              ...
              <div className="mt-5 w-8/12">
                <p className="text-[#6B6A6A] text-sm">
                Leverage BSG’s business and product strategy team to kickstart product thinking at your organization.
                </p>
                <p className="mt-5 text-[#6B6A6A] text-sm ">Services:</p>
                <ul class="list-disc mt-5 text-[#6B6A6A] text-sm ml-8">
                  <li>Small Business Digital Consulting </li>
