...
export const Footer = () => {
  return (
    <div className="flex items-center justify-center bg-black mt-20">
      <div className="lg:w-10/12 md:w-12/12 w-11/12 min-w-xs  max-w-6xl">
        <div className=" bg-black py-10 md:px-5 lg:px-5 px-0 w-full ">
          ...
          <div className="lg:mt-24 md:mt-24 mt-12">
            ...
            <div className="flex w-full lg:items-center md:items-center justify-between mt-4 lg:flex-row md:flex-row flex-col">
              ...
              <div className="lg:w-3/12 md:w-3/12 py-2 lg:px-10 md:px-10 gap-5 flex flex-col lg:border-l-2 lg:border-l-white md:border-l-2 md:border-l-white border-b-2 border-b-white lg:border-b-0 lg:pb-0 md:border-b-0 md:pb-0 pb-5">
                <div>
                  <Link to={"/about-us"}>
